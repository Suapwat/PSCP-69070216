...
```text
โจทย์ให้รับค่าแม่สีมาสองสี แล้วนำมาผสมกัน แล้วดูว่าได้สีอะไร

Input:
รับค่าstring แม่สี 2 ค่า
Output:
ค่าสีที่ผสมกันแล้วได้ออกมา

Constraints:
ต้องรู้ว่าแต่ละสีผสมกันแล้วได้สีอะไรบ้าง
```
...
```text
1.รับค่า string แม่สี 2 ค่า
2.ถ้าสี1หรือ2เป็นแดง และสี1หรือ2เป็น เหลือง ให้แสดง"Orange"
3""ถ้าเป็นแดงนํ้าเงิน ให้แสดง"Violet"
4.""ถ้าเป็นนํ้าเหลืองให้แสดง"Green"
5.นอกจากนี้แสดง"Error"
```
...
```text
คล้ายๆแผนแรก แต่เพิ่มเงื่อนไขถ้าหากแม่สีที่รับมาเป็นสีเดียวกัน ให้ได้แม่สีเดิมลงไป
```
...
```text
เพื่อเช็คว่าเงื่อนไข สีแดง-นํ้าเงินทำงานได้ไหม
```
