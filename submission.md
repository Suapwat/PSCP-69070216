...
```text
โจทย์ให้เขียนโปรแกรมรับค่าข้อความมา แล้วจากนั้นให้แสดงข้อความนั้นแบบย้อนกลับ
Input:
รับค่าตัวอักษร 5 ตัว

Output:
แสดงข้อความแบบย้อนกลับและเป็นตัวเล็ก

Constraints:
รับค่า เป็นstring และต้องแปลงให้outputออกเป็นตัวพิมพ์เล็กด้วย
```
...
```text
1. รับค่าstring
2. แสดงผลเป็นตัวพิมเล็ก และพิมจากตัวท้ายสุดมาตัวแรก
```
...
```text
ทำเหมือนแผนแรก ใช้Sting slicing แสดงข้อความแบบย้อนกลับและใช้Method .lower()เพื่อให้ตัวแปลงเป็นตัวพิมพ์เล็ก
```
...
```text
ทดสอบว่าสามารถรันคำสั่งได้ปกติหรือไม่
```
...
```text
ทดสอบว่าถ้าพิมพ์ใหญ่ทุกตัวจะoutputจะยังถูกต้องไหม
```
...
```text
ทดสอบว่าถ้ามีตัวพิมใหญ่บางตัวจะแปลงเป็นพิมพ์เล็กหรือไม่
```
