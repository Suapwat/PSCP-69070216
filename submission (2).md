...
```text
โจทย์ให้รับค่าจำนวนเต็ม ของค่าอาหาร แล้วให้คำนวนค่าsevice จากนั้นให้คิดVat7% ที่ได้จากการนำค่าอาหารรวมกับservice แล้ว

Input:
รับค่าจำนวนเต็ม 1 ค่า 

Output:
โปรแกรมคำนวนค่าใช้จ่ายทั้งหมดหลังจากคิดค่า service และ Vat7%

Constraints:
โจทย์กำหนดว่า service ต้องไม่ตํ่ากว่า50 และไม่มากกว่า 1000 บาท
...
```text
1.INPUT bill
2.service  = bill*10/100
3.IF sevice > 50 
4.ให้service = 50
5.IF service > 1000
6.ให้service = 1000
7. vat = (bill+service)*7/100
8.total = bill+service+vat
9.PRINT total
```
...
```text
เหมือนแผนแรก รับค่าbill และคำนวนค่าservice กับ vat จากนั้น แสดงค่าtotal ก็คือ bill+service+vat
```
...
```text
เช็คค่าเมื่อservice < 50 ให้ service = 50
```
...
```text
เช็คเมื่อ service > 50 ให้ service = 1000
```
...
```text
เช็คถ้าค่า 50<=service<=1000 แสดงผลได้ปกติไหม
```
